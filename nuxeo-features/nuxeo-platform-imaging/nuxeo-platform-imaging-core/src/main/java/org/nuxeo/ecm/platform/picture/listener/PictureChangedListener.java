...
public class PictureChangedListener implements EventListener {
    ...
    protected boolean triggersPictureViewsGeneration(Event event, DocumentModel doc) {
        ...
        // triggers picture view generation when
        // - force generation is true
        // - creating or updating a doc with no picture views set or not dirty
        // - checkin a doc with no picture views set
